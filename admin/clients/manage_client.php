...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Editar ": "Nuevo " ?> Cliente</h3>
	</div>
	<div class="card-body">
		<form action="" id="client-form">
			...
			<div class="form-group">
				...
				<small><em class="text-muted">Complete solo para actualizar la contraseña del cliente</em></small>
			</div>
            <div class="form-group">
