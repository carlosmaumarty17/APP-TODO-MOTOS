 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            ...
            <p class="lead fw-normal text-white-50 mb-0">Nos encargaremos de su vehículo</p>
            <div class="col-auto mt-2">
                <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Solicitar Servicio</button>
            </div>
        </div>
    </div>
</header>
...
<script>
    $(function(){
        ...
        $('#send_request').click(function(){
            ...
            uni_modal("Complete el Formulario de Solicitud de Servicio","send_request.php",'mid-large');
            else
